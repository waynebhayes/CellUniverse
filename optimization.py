...
def show_diffimage_cost(diffimage, cost):
    "add cost on diffimage"
    diffimage = Image.fromarray(diffimage)
    fillcolor = "#00ff00"
    Draw_test = ImageDraw.Draw(diffimage)
    myfont = ImageFont.truetype('/home/yi/PycharmProjects/CellUniverse/Arial.ttf')
    str_cost = str(cost)
    Draw_test.text((50, 50), str_cost, font=myfont, fill=fillcolor)
    return diffimage
