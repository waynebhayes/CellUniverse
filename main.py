...
from find_contour import contour
...
def main() -> int:
    ...
    convert(options.output_dir)  # convert the former csv file that can be used for lineage tree
    contour('./synthetic/', options.input_files, options.output_dir.name, len(options.input_files))
    # find contour of simulated cells and draw red circles
