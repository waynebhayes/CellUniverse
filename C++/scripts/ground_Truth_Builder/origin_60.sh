...
LOG_FILE="$LOG_DIR/origin_60_ground_truth_runLog_$(date +%Y%m%d_%H%M%S).txt"
exec > >(tee -a "$LOG_FILE") 2>&1
echo "[INFO] Logging to: $LOG_FILE"

INPUT_FILE="$CPP_ROOT/examples/input/original_data/frame060.tif"
CONFIG_FILE="$CPP_ROOT/config/config.yaml"
CSV_FILE_NAME="initial_origin_60.csv"
OUT_DIR="$OUTPUT_ROOT/output_origin_60_$(date +%Y%m%d_%H%M%S)"
...
echo "======================================================================================================="
echo "Cell Universe Original Frame 60 Ground Truth Builder"
echo "======================================================================================================="
